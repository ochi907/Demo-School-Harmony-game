...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            imagebutton auto "gui/mm_start_%s.png" xpos 576 ypos 385 focus_mask True action Start () hovered [ Play ("sound","audio/click.mp3") ]
        ...
        imagebutton auto "gui/mm_load_%s.png" xpos 582 ypos 400 focus_mask True action ShowMenu ("load") hovered [ Play ("sound","audio/click.mp3") ]

        textbutton _("Preferences") action ShowMenu("preferences") ##

        imagebutton auto "gui/mm_options_%s.png" xpos 546 ypos 413 focus_mask True action ShowMenu ("preferences") hovered [ Play ("sound","audio/click.mp3") ]
        ...
        if renpy.variant("pc"):
            ...
            imagebutton auto "gui/mm_quit_%s.png" xpos 585 ypos 427 focus_mask True action Quit(confirm=not main_menu) hovered [ Play ("sound","audio/click.mp3") ]
